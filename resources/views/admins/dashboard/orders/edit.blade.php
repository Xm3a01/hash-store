                                ...
                                <div class="col-md-5 m-x-auto pull-xs-none vamiddle">
                                    <div class="card">
                                        <div class="card-block p-a-2">
                                            ...
                                            <form class="form-control" action="{{ route('orders.update', $order->id) }}"
                                                ...
                                                <div class="input-group m-b-1">
                                                    ...
                                                    <input name="name" type="text" class="form-control"
                                                        placeholder=" اسم المنتج " value="{{ $order->name }}">
                                                </div>

                                                <div class="input-group m-b-1">
                                                    <input type="number" step="0.01" name="quantity" class="form-control"
                                                        placeholder="   الكمية  " value="{{ $order->quantity }}">
                                                </div>
                                                <div class="input-group m-b-1">
                                                ...
                                                <div class="input-group m-b-1">
                                                    ...
                                                    <select name="user_id" id="" class="form-control">
                                                        ...
                                                        @foreach ($users as $user)
                                                            <option {{ $order->user_id == $user->id ? 'selected' : '' }}
