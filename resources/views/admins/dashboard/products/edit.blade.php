                ...
                <div class="card">
                   <div class="card-block p-a-2">
                        ...
                        <div class="input-group m-b-1">
                            ...
                            <input type="color" id="favcolor" name="favcolor" value="#123456" >
                        </div>
                         <div class="input-group m-b-1">
                            
                           
                            <label> اختر الألوان المتاحة من المنتج </label>  &ensp; &ensp; &ensp;   
                            <input type="color" id="favcolor" name="favcolor" value="#123456" >
                        </div>
                        <div class="input-group m-b-1">
                            
                        
                            <input type="number" step="0.01"  class="form-control" placeholder=" حجم المنتج ">
                        </div>
                        <div class="input-group m-b-1">
                            
                        
                            <input type="number" step="0.01"  class="form-control" placeholder=" الأحجام المتوفره من المنتج ">
                        </div>
                        <div class="input-group m-b-1">
                            
                        
                            <input type="number" step="0.01"class="form-control" placeholder="  الخصم  ">
                        </div>
                        <div class="input-group m-b-1">
                        ...
                        <div class="input-group m-b-1">
                            ...
                            <input type="number" step="0.01" class="form-control" placeholder="  السعر ">
                        </div>
                         <div class="input-group m-b-1">
