      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-2 col-md-pull-5">
            ...
            >
              <div
                class="product-preview image-rdadius"
                :style="preview == image ? `border:none` : ``"
              >
                <img :src="image" alt="" @mouseover.prevent="change(image)" />
              </div>
            </div>
          </div>
          <!-- /Product thumb imgs -->
            ...
            <div class="product-details">
              ...
              <div>
                ...
                <span class="product-available">{{
                  product.productAmount ? "Avialable" : "In Stock"
                }}</span>
              </div>
              ...
              <div class="add-to-cart">
                ...
                <button @click="cartAdd(product.id)" class="add-to-cart-btn">
